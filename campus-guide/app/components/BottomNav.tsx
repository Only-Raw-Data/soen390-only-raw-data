...
export function BottomNav({ currentScreen, onScreenChange }: BottomNavProps) {
    const navItems = [
        ...
        { id: 'directions' as Screen, icon: 'navigate-outline' as const, label: 'Directions' },
        { id: 'schedule' as Screen, icon: 'calendar-outline' as const, label: 'Schedule' },
        { id: 'indoor' as Screen, icon: 'business-outline' as const, label: 'Indoor' },
