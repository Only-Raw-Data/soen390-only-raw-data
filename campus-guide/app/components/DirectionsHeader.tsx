...
import { useDirections, TransportationMode } from '../context/DirectionsContext';
                ...
                <View style={styles.inputsContainer}>
                    <View style={styles.inputWrapper}>
                        ...
                        <TextInput
                            ...
                            value={isSearchingStart ? searchQuery : (startBuilding?.name || '')}
                            onFocus={() => {
                ...
                <View style={styles.modesContainer}>
                    {modes.map(mode => (
                        ...
                        >
                            ...
                            <Text style={[
                                styles.modeLabel,
                                transportationMode === mode.id && styles.modeLabelActive
                            ]}>
                                {mode.label}
                            </Text>
                        </TouchableOpacity>
